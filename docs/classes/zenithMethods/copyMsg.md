...
::: tip Примечание
Параметр `caption` (подпись) работает только при копировании **одного** сообщения. При копировании массива сообщений Telegram API не поддерживает добавление новой подписи.
:::
